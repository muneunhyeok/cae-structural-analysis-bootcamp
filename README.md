...
![코멘토 연구개발 직무부트캠프 수료증](assets/comento-bootcamp-certificate.png)

| | |
|---|---|
| **과정** | (주)코멘토 연구개발 직무부트캠프 — 해석 업무의 기초와 핵심, CAE 구조해석 실무 AtoZ 경험하기 |
| **기간** | 2026.07.07 ~ 2026.08.04 |
| **수료일** | 2026.08.04 |

📄 [수료증 원본 (PDF) →](assets/comento-bootcamp-certificate.pdf)
